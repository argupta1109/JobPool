...
--
-- Table structure for table `companyposts`
--
...
--
-- Dumping data for table `companyposts`
--
...
--
-- Table structure for table `list_college`
--
...
--
-- Dumping data for table `list_college`
--
...
--
-- Table structure for table `studentvalidaterequest`
--
...
--
-- Indexes for table `companyposts`
--
...
--
-- AUTO_INCREMENT for table `companyposts`
--
ALTER TABLE `companyposts`
